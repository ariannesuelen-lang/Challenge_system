...
def tela_batalha_integrantes():
    ...
    st.title("Integrantes dos Times")
    ...
    # --------------------------------------------------
        ...
        if not data:
            st.warning("Voce nao participa de nenhum time ainda.")
        ...
        st.success(f"Seu time: {time_info['nome']}")
    ...
    # --------------------------------------------------
    # GESTAO DE MEMBROS (professor)
    # --------------------------------------------------
    st.divider()
    st.subheader("Gestao de membros")
    ...
    st.divider()
    st.subheader("Mover aluno para outro time")
