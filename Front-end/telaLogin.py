    ...
    with st.form("form_editar_usuario"):
        ...
        if st.form_submit_button("💾 Salvar"):
            ...
            if res and res.status_code == 200:
                ...
                st.error(res.json().get("detail", "Erro ao atualizar."))
